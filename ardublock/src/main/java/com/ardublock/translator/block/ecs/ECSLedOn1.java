...
public class ECSLedOn1 extends TranslatorBlock
{
	public ECSLedOn1(Long blockId, Translator translator, String codePrefix,	String codeSuffix, String label)
	{
	...
	{	
		...
		return "digitalWrite( " + LED_PIN_1 + " , HIGH);\n";
	}
}
