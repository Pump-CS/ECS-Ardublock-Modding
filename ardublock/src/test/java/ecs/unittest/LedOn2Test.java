...
public class LedOn2Test
{
	...
	@Test
	public void ledOn2Test_noInput_Success() {
		blockToTest = new ECSLedOn2(ECSTestUtil.TEST_ID, translator, "", "", "");
