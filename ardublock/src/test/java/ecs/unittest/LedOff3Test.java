...
public class LedOff3Test
{
	...
	@Test
	public void ledOff3Test_noInput_Success() {
		blockToTest = new ECSLedOff3(ECSTestUtil.TEST_ID, translator, "", "", "");
